...
- **Architectural Control:** The decision to place the CSRF middleware *after* the initial auth routes was made after a manual risk assessment to balance user experience (UX) against security.
